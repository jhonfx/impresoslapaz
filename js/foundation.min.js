...
(function (e) {
    ...
    e(document).on("click", "a[data-reveal-id]", function (t) {
        ...
        var r = e(document), i = {animation:"fade", animationSpeed:600, closeOnBackgroundClick:500, dismissModalClass:"close-reveal-modal", open:e.noop, opened:e.noop, close:e.noop, closed:e.noop};
        return n = e.extend({}, i, n), this.not(".reveal-modal.open").each(function () {
            ...
            var i = e(this), s = parseInt(i.css("top"), !0), o = i.height() + s, u = !1, a = e(".reveal-modal-bg"), f = {open:{top:0, opacity:0, visibility:"visible", display:"block"}, close:{top:s, opacity:1, visibility:"hidden", display:"none"}}, l;
...
(function (e, t, n) {
    ...
    e.fn.foundationButtons = function (t) {
        ...
        r.on("click.fndtn", ".button.disabled", function (e) {
            ...
            t.target.nodeName !== "A" && t.preventDefault(), setTimeout(function () {
...
(function (e, t, n) {
    ...
    var r = {bodyHeight:0, selector:".has-tip", additionalInheritableClasses:[], tooltipClass:".tooltip", tipTemplate:function (e, t) {
        ...
        var n = ["tip-top", "tip-left", "tip-bottom", "tip-right", "noradius"].concat(r.additionalInheritableClasses), i = t.attr("class"), s = i ? e.map(i.split(" "),function (t, r) {
